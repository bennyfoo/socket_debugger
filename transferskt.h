#ifndef TRANSFERSKT_H
#define TRANSFERSKT_H
...
public:
    TransferSkt(QObject *parent=Q_NULLPTR);
	virtual ~TransferSkt();
...
public:
    TransferSktTcp(QObject *parent=Q_NULLPTR);
...
public:
    TransferSktUdp(QObject *parent=Q_NULLPTR);
