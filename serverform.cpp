...
#define SET_KEY_SRV_EDIT1  "/lineText1"
#define SET_KEY_SRV_EDIT2  "/lineText2"
#define SET_KEY_SRV_EDIT3  "/lineText3"
#define SET_KEY_SRV_EDIT4  "/lineText4"
...
void ServerForm::initConfig()
{
    ...
    Setting::lord(sss+SET_KEY_SRV_EDIT1, *m_ui.edtBuf1);
    Setting::lord(sss+SET_KEY_SRV_EDIT2, *m_ui.edtBuf2);
    Setting::lord(sss+SET_KEY_SRV_EDIT3, *m_ui.edtBuf3);
...
void ServerForm::saveConfig()
{
    ...
    Setting::save(sss+SET_KEY_SRV_EDIT1, *m_ui.edtBuf1);
    Setting::save(sss+SET_KEY_SRV_EDIT2, *m_ui.edtBuf2);
    Setting::save(sss+SET_KEY_SRV_EDIT3, *m_ui.edtBuf3);
